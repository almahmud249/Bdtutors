        ...
        <v-col cols="12" sm="6" md="9">
          <v-card max-width="1000">
                ...
                <div>
                  <v-card-text>
                    ...
                    <h5>
                      ...
                      {{ info.personal_information.desc }}
                    </h5>
                  </v-card-text>
            ...
            <div class="text-right mb-n5">
              <router-link to="/tutionInfo" style="text-decoration:none">
                <v-btn depressed>
            ...
            <v-row class="ml-5">
              ...
              <v-col md="8" class="mt-10">
                <v-row>
                  <div v-for="data in allData[3]" :key="data.value">
                    <v-checkbox
                      class="mt-n8"
                      :label="data"
                      dense
            ...
            <v-row class="ml-5">
              ...
              <v-col md="8" class="mt-10">
                <v-row>
                  <div v-for="data in allData[4]" :key="data.value">
                    <v-checkbox
                      class="mt-n8"
                      :label="data"
                      dense
            ...
            <v-row class="ml-5">
              <v-col md="4" class="mt-2">
                <h4>Preferred Preferred Subjects:</h4>
              </v-col>
              <v-col>
                <v-row class="mt-1">
                  <div small v-for="data in allData[3]" :key="data.value">
                    <v-checkbox
                      v-if="data"
                      :label="data"
                      input-value="true"
            ...
            <v-row class="ml-5">
              <v-col md="4" class="mt-2">
                <h4>Preferred Areas to Teach:</h4>
              </v-col>
              <v-col>
                <v-row class="mt-1">
                  <div small v-for="data in allData[0]" :key="data.value">
                    <v-checkbox
                      v-if="data"
                      :label="data"
                      input-value="true"
...
export default {
  ...
  created() {
    ...
    // this.prefer_area = this.data.map(([lat, lng]) => ({lat, lng}));
